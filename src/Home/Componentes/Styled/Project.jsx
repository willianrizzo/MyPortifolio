        ...
        <div>
            <div className='w-[95%] flex gap-20 m-auto mt-20'>
                    <div className='flex flex-col gap-5 w-[35%] h-auto bg-[#1c6697] p-5 items-center rounded-md'>
                        ...
                        <a href='https://welldnez-food.vercel.app' className='w-[50%] text-lg text-center text-[#0EE6B7] bg-[#0b4164] p-1.5 rounded-lg'>Conheça a Welldnez!</a>
                    </div>
                    ...
                    <div className='flex flex-col gap-5 w-[35%] h-auto bg-[#1c6697] p-5 items-center rounded-md'>
                        ...
                        <p className='text-white'>Nosso último e maior projeto desenvolvido no Instituto PROA! A Connect Health é uma multiplataforma que leva informações e consultas onlines com profissionais das áreas da psicologia e da nutrição, tudo isso por um preço acessível! Venha conhecer a Connect!</p>
                        <img className='rounded-md' src={Connect} alt="" />
                        <a href="https://connect-health.net.br" className='w-[50%] text-lg text-center target:"_blank" text-[#0EE6B7] bg-[#0b4164] p-1.5 rounded-lg'>Visite a Connect!</a>
                    </div>
